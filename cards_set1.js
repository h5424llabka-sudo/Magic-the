...
const SET1_CARDS = {
    ...
    f_c18: { name: '火山の巨人', type: 'CREATURE', color: 'fire', cost: 3, power: 2, toughness: 2, haste: false, rarity: 'R', text: '【出たとき】: 対象に3ダメージ。', abilities: [], triggered: {"condition":"etb","effect":"dmg_any_3"} },
    f_c19: { name: '暴君竜', type: 'CREATURE', color: 'fire', cost: 5, power: 4, toughness: 4, haste: false, rarity: 'M', text: '【起動】(①①): 対象に2ダメージ。\n【出たとき】: 対象プレイヤーに2ダメージ。', abilities: [], activated: {"cost":2,"tap":false,"effect":"dmg_any_2"}, triggered: {"condition":"etb","effect":"dmg_p_2"} },
    f_c20: { name: '災厄の化身', type: 'CREATURE', color: 'fire', cost: 5, power: 5, toughness: 5, haste: true, rarity: 'M', text: '【速攻】【飛行】\n【起動】(①): ターン終了時まで+1/+0。', abilities: ['flying'], activated: {"cost":1,"tap":false,"effect":"buffself_self_1"} },
    f_s1: { name: '火花', type: 'SPELL', color: 'fire', cost: 1, effect: 'dmg_any_2', rarity: 'C', text: '対象に2ダメージ。', abilities: [] },
    f_s2: { name: 'ショック', type: 'SPELL', color: 'fire', cost: 2, effect: 'dmg_p_3', rarity: 'C', text: '相手に3ダメージ。', abilities: [] },
    ...
    f_s5: { name: 'ゴブリンの奇襲', type: 'SPELL', color: 'fire', cost: 4, effect: 'dmg_p_5', rarity: 'C', text: '相手に5ダメージ。', abilities: [] },
    f_s6: { name: '稲妻', type: 'SPELL', color: 'fire', cost: 3, effect: 'dmg_cr_4', rarity: 'U', text: '対象クリーチャーに4ダメージ。', abilities: [] },
    ...
    f_s12: { name: '集団強化', type: 'SPELL', color: 'fire', cost: 4, effect: 'buffall_self_3_2', rarity: 'M', text: '味方全体を+3/+2。', abilities: [] },
    g_c1: { name: 'エルフの戦士', type: 'CREATURE', color: 'forest', cost: 1, power: 1, toughness: 1, haste: false, rarity: 'C', text: '【起動】(①①, タップ): マナ加速。', abilities: [], activated: {"cost":2,"tap":true,"effect":"ramp_self_1_1"} },
    g_c2: { name: '蜘蛛', type: 'CREATURE', color: 'forest', cost: 2, power: 1, toughness: 2, haste: false, rarity: 'C', text: '【到達】【接死】', abilities: ['deathtouch', 'reach'] },
    ...
    g_c10: { name: '大地の精霊', type: 'CREATURE', color: 'forest', cost: 4, power: 4, toughness: 5, haste: false, rarity: 'U', text: '【到達】', abilities: ['reach'] },
    ...
    g_c19: { name: '世界樹の化身', type: 'CREATURE', color: 'forest', cost: 6, power: 5, toughness: 5, haste: false, rarity: 'M', text: '【起動】(①①): 2/2のトークンを生成。\n【出たとき】: 2/2のトークンを生成。', abilities: [], activated: {"cost":2,"tap":false,"effect":"token_self_2_2"}, triggered: {"condition":"etb","effect":"token_self_2_2"} },
    ...
    g_s1: { name: '巨大化', type: 'SPELL', color: 'forest', cost: 1, effect: 'buff_cr_2_2', rarity: 'C', text: '対象クリーチャーを+2/+2。', abilities: [] },
    g_s2: { name: '自然の恵み', type: 'SPELL', color: 'forest', cost: 2, effect: 'heal_self_5', rarity: 'C', text: 'ライフ5回復。', abilities: [] },
    g_s3: { name: '野生の力', type: 'SPELL', color: 'forest', cost: 2, effect: 'buff_cr_3_3', rarity: 'C', text: '対象クリーチャーを+3/+3。', abilities: [] },
    g_s4: { name: '蜘蛛の糸', type: 'SPELL', color: 'forest', cost: 1, effect: 'tap_cr_0', rarity: 'C', text: '対象クリーチャーをタップさせる。', abilities: [] },
    g_s5: { name: '生命の芽吹き', type: 'SPELL', color: 'forest', cost: 2, effect: 'ramp_self_1', rarity: 'C', text: 'マナ加速。', abilities: [] },
    g_s6: { name: '豊かな森', type: 'SPELL', color: 'forest', cost: 4, effect: 'ramp_self_2', rarity: 'U', text: '2マナ加速。', abilities: [] },
    ...
    g_s9: { name: '獣の群れ', type: 'SPELL', color: 'forest', cost: 4, effect: 'buffall_self_1_1', rarity: 'U', text: '味方全体を+1/+1。', abilities: [] },
    g_s10: { name: '踏み荒らし', type: 'SPELL', color: 'forest', cost: 5, effect: 'buffall_self_2_2', rarity: 'R', text: '味方全体+2/+2。', abilities: [] },
    g_s11: { name: '自然の怒り', type: 'SPELL', color: 'forest', cost: 5, effect: 'destroy_cr_1_1', rarity: 'R', text: '対象を破壊。', abilities: [] },
    ...
    w_c10: { name: '大蛇', type: 'CREATURE', color: 'water', cost: 4, power: 3, toughness: 3, haste: false, rarity: 'U', text: '【出たとき】: 2枚ドロー。', abilities: [], triggered: {"condition":"etb","effect":"draw_self_2_2"} },
    ...
    w_c15: { name: '海竜', type: 'CREATURE', color: 'water', cost: 6, power: 6, toughness: 6, haste: false, rarity: 'R', text: '【トランプル】\n【出たとき】: 2枚ドロー。', abilities: ['trample'], triggered: {"condition":"etb","effect":"draw_self_2_2"} },
    w_c16: { name: '氷の巨人', type: 'CREATURE', color: 'water', cost: 6, power: 6, toughness: 6, haste: false, rarity: 'R', text: '【出たとき】: 相手をタップさせる。', abilities: [], triggered: {"condition":"etb","effect":"tap_opp_0"} },
    ...
    w_s5: { name: '打ち消し', type: 'SPELL', color: 'water', cost: 2, effect: 'discard_opp_1', rarity: 'C', text: '相手の手札を1枚捨てる。', abilities: [] },
    w_s6: { name: '集中', type: 'SPELL', color: 'water', cost: 5, effect: 'draw_self_3', rarity: 'U', text: '3枚ドロー。', abilities: [] },
    ...
    w_s9: { name: '知識の泉', type: 'SPELL', color: 'water', cost: 6, effect: 'draw_self_4', rarity: 'U', text: '4枚ドロー。', abilities: [] },
    w_s10: { name: '激流', type: 'SPELL', color: 'water', cost: 5, effect: 'bounce_allcr_1', rarity: 'R', text: '全クリーチャーを手札に。', abilities: [] },
    w_s11: { name: '精神支配', type: 'SPELL', color: 'water', cost: 4, effect: 'destroy_cr_1_1', rarity: 'R', text: '対象クリーチャーを破壊。', abilities: [] },
    ...
    l_c2: { name: '僧侶', type: 'CREATURE', color: 'light', cost: 1, power: 1, toughness: 3, haste: false, rarity: 'C', text: '【防衛】【絆魂】', abilities: ['lifelink', 'defender'] },
    ...
    l_c17: { name: '百人隊長', type: 'CREATURE', color: 'light', cost: 5, power: 5, toughness: 5, haste: false, rarity: 'R', text: '【先制攻撃】', abilities: ['first_strike', 'vigilance'] },
    ...
    l_s8: { name: '追放', type: 'SPELL', color: 'light', cost: 4, effect: 'destroy_cr_1_1', rarity: 'U', text: '対象クリーチャーを破壊。', abilities: [] },
    l_s9: { name: '結束', type: 'SPELL', color: 'light', cost: 4, effect: 'buffall_self_2_2', rarity: 'U', text: '味方全体+2/+2。', abilities: [] },
    l_s10: { name: '神の怒り', type: 'SPELL', color: 'light', cost: 3, effect: 'destroy_cr_1_1', rarity: 'R', text: '対象クリーチャーを破壊。', abilities: [] },
    ...
    d_s2: { name: '恐怖', type: 'SPELL', color: 'dark', cost: 4, effect: 'destroy_cr_1', rarity: 'C', text: '対象を破壊。', abilities: [] },
    ...
    d_s7: { name: '殺害', type: 'SPELL', color: 'dark', cost: 3, effect: 'destroy_cr_1', rarity: 'U', text: '対象を破壊。', abilities: [] },
    d_s8: { name: '生命吸収', type: 'SPELL', color: 'dark', cost: 6, effect: 'drain_p_4', rarity: 'U', text: '相手から4点吸収。', abilities: [] },
    ...
    d_s11: { name: '滅び', type: 'SPELL', color: 'dark', cost: 6, effect: 'destroy_allcr_1', rarity: 'R', text: '全クリーチャー破壊。', abilities: [] },
    d_s12: { name: '死の宣告', type: 'SPELL', color: 'dark', cost: 6, effect: 'dmg_p_10_10', rarity: 'M', text: '相手に10ダメージ。', abilities: [] }
};
