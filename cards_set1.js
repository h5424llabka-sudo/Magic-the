...
const SET1_CARDS = {
    ...
    g_c6: { name: '大狼', type: 'CREATURE', color: 'forest', cost: 3, power: 3, toughness: 3, haste: false, rarity: 'C', text: '【先制攻撃】', abilities: ['first_strike'] },
    ...
    g_c13: { name: 'エルフの王', type: 'CREATURE', color: 'forest', cost: 3, power: 3, toughness: 3, haste: false, rarity: 'U', text: 'エルフの統率者。', abilities: [] },
    ...
    g_c17: { name: 'ティラノサウルス', type: 'CREATURE', color: 'forest', cost: 7, power: 9, toughness: 8, haste: false, rarity: 'R', text: 'ジュラシック。', abilities: [] },
    ...
    w_c13: { name: '幻影の竜', type: 'CREATURE', color: 'water', cost: 5, power: 5, toughness: 5, haste: false, rarity: 'U', text: '【飛行】', abilities: ['flying'] },
